...
class CubicParam(Parametrization):
    ...
    symmetry = 4 element array that indicates with 0 or 1 if there is reflection symmetry
                    about the x, y axis and/or over the primary/secondary diagonal
    ...
    def __init__(self,
                 ...
                 fine_x: np.ndarray,
                 fine_y: np.ndarray,
                 symmetry: np.ndarray = np.array([0, 0, 0, 0]),
